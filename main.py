 ...
 #============================================== Functions of loading  and reading Images ==============================================
    ...
    def update_mixer_data(self):
        ...
        for mixer_data in range(2):
           ...
           if (self.Mixer_Components[mixer_data]=='uniformphase' or self.Mixer_Components[mixer_data]=="uniformmagnitude"):
             self.Mixer_Sliders[mixer_data].setValue(0)
             self.Mixer_Sliders[mixer_data].setEnabled(False)
           else:
             self.Mixer_Sliders[mixer_data].setEnabled(True)
